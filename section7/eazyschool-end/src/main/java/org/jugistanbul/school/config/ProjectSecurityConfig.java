package org.jugistanbul.school.config;

import org.jugistanbul.school.handler.CustomAuthenticationFailureHandler;
import org.jugistanbul.school.handler.CustomAuthenticationSuccessHandler;
...
public class ProjectSecurityConfig {
    ...
    public UserDetailsService userDetailsService() {
        ...
        UserDetails admin = User.withUsername("admin")
                .password("{bcrypt}$2a$12$gJsdxH8CKg5ezlSTPGnL2O4BjpiBNQL3NwVtXlCYcMULWrMHzvmza")
